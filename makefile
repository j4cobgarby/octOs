...
all:
	...
	# building C
	i686-elf-gcc -ffreestanding -c src/kernel/kio.c -o build/kio.o -I src/include
	i686-elf-gcc -ffreestanding -c src/kernel/pmm.c -o build/pmm.o -I src/include
	i686-elf-gcc -ffreestanding -c src/kernel/asm_procs.c -o build/asm_procs.o -I src/include
